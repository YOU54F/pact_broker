Sequel.migration do
  change do
    create_table(:branches, charset: "utf8") do
      primary_key :id
      String :name
      foreign_key :application_id, :applications, null: false, on_delete: :cascade
      DateTime :created_at, null: false
      DateTime :updated_at, null: false
      index [:application_id, :name], unique: true, name: :branches_application_id_name_index
    end
    ...
    create_table(:branch_versions, charset: "utf8") do
      ...
      index [:application_id, :branch_id, :version_order], name: :branch_versions_application_id_branch_id_version_order_index
    end
    ...
    create_table(:branch_heads) do
      ...
      index [:application_id], name: :branch_heads_application_id_index

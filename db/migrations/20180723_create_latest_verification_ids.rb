Sequel.migration do
  up do
    ...
    create_table(:latest_verification_id_for_pact_version_and_provider_version, charset: "utf8") do
      foreign_key :consumer_id, :applications,      null: false, on_delete: :cascade, foreign_key_constraint_name: "latest_v_id_for_pv_and_pv_consumer_id_fk" # not required, but useful to avoid extra joins
      ...
      foreign_key :provider_id, :applications,      null: false, on_delete: :cascade, foreign_key_constraint_name: "latest_v_id_for_pv_and_pv_provider_id_fk"  # not required, but useful to avoid extra joins

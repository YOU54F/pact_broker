...
Pact.service_provider "Pact Broker" do
  ...
  honours_pact_with "Pact Broker Client" do
    pact_uri "https://raw.githubusercontent.com/pact-foundation/pact_broker-client/refs/heads/feat/v2/spec/pacts/Pact%20Broker%20Client%20V2-Pact%20Broker.json"
  end
end

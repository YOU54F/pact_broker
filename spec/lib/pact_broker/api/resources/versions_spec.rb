  ...
  module Api
    module Resources
      describe Versions do
        let(:path) { "/applications/Foo/versions/" }
        ...
        describe "GET" do
          ...
          context "when the application and version do not exist" do
            ...
            its(:body) { expect(JSON.parse(subject.body, symbolize_names: true)[:error]).to match(/No application/) }
          end
          ...
          context "when the application and version exist" do
            ...
            context "response body" do
              ...
              it "contains the expected keys" do
                ...
                expect(response_body_hash[:_links][:"pb:application"]).to include(:title, :href)
                expect(response_body_hash[:_links][:"pb:application"][:title]).to eq "Foo"

require "pact_broker/api/resources/application_webhooks"

module PactBroker::Api
  module Resources
    describe ApplicationWebhooks do
      ...
      let(:provider) { instance_double(PactBroker::Domain::Application) }
      let(:consumer) { instance_double(PactBroker::Domain::Application) }

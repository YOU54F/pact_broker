...
begin
  ...
  td.delete_application("LongTagProvider")
    .create_environment(name: "prod", production: true)
    .create_application("LongTagProvider")
    .create_tagged_application_version(application: "LongTagProvider", version: "1", tag: "chore/update-from-oss-02b1c90b4113eb7fbe752a2991bf34f94898e845")
    .deploy_to_prod(application: "LongTagProvider", version: "1")
    ...
    .deploy_to_prod(application: "LogTagConsumer", version: "1")

...
module PactBroker
  module Versions
    class Branch < Sequel::Model(:branches)
      ...
      plugin :insert_ignore, identifying_columns: [:name, :application_id]
...
#  branches_application_id_name_index | UNIQUE btree (application_id, name)
# Foreign key constraints:
#  branches_application_id_fkey | (application_id) REFERENCES applications(id) ON DELETE CASCADE
# Referenced By:

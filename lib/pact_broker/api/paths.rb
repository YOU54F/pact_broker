module PactBroker
  module Api
    module Paths
      ...
      CAN_I_MERGE_BADGE_PATH = %r{^/applications/[^/]+/main-branch/can-i-merge/badge(?:\.[A-Za-z]+)?$}.freeze
      CAN_I_DEPLOY_TAG_BADGE_PATH = %r{^/applications/[^/]+/latest-version/[^/]+/can-i-deploy/to/[^/]+/badge(?:\.[A-Za-z]+)?$}.freeze
      CAN_I_DEPLOY_BRANCH_ENV_BADGE_PATH = %r{^/applications/[^/]+/branches/[^/]+/latest-version/can-i-deploy/to-environment/[^/]+/badge(?:\.[A-Za-z]+)?$}.freeze

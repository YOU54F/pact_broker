...
module PactBroker
  module Api
    module Resources
      class CanIDeployApplicationVersionByBranchToEnvironment < BaseResource
        def allowed_methods
          ["GET", "OPTIONS"]
        end
        ...
        def version
          @version ||= version_service.find_latest_by_application_name_and_branch_name(identifier_from_path[:application_name], identifier_from_path[:branch_name])
        end

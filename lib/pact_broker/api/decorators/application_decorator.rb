  ...
  module Api
    module Decorators
      class ApplicationDecorator < BaseDecorator
        ...
        # The associations that should be eager loaded on the Application so that this
        ...
        link :'pb:branches' do | options |
          application_branches_url(represented, options[:base_url])
        end
        ...
        link :'pb:version' do | options |
          {
            ...
            href: templated_version_url_for_application(represented.name, options[:base_url]),
            templated: true
          }
        end
        ...
        link :'pb:version-tag' do | options |
          {
            ...
            href: templated_tag_url_for_application(represented.name, options[:base_url]),
            templated: true
          }
        end
        ...
        link :'pb:branch-version' do | options |
          {
            ...
            href: templated_branch_version_url_for_application(represented.name, options[:base_url]),
            templated: true
          }
        end
        ...
        link :'pb:label' do | options |
          {
            ...
            href: templated_label_url_for_application(represented.name, options[:base_url]),
            templated: true
          }
        end
        ...
        curies do | options |
          [{
            name: :pb,
            href: options[:base_url] + "/doc/{rel}?context=application",
            templated: true
          }]
        end

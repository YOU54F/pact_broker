...
require "pact_broker/api/decorators/embedded_application_decorator"
  ...
  module Api
    module Decorators
      class EmbeddedDeployedVersionDecorator < BaseDecorator
        ...
        property :application, :extend => EmbeddedApplicationDecorator, writeable: false, embedded: true, if: -> (user_options:, **_other) { user_options[:expand]&.include?(:application) }
